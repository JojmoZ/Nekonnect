...
import { BaseService, createTransactionActor, transactionCanisterId, loanPostCanisterId, userCanisterId } from "./base.service";
...
export class TransactionService extends BaseService {
    ...
    async createTransaction(loanId: string, amount: number, method: string, userId: Principal) {
        return await this.transaction.createTransaction(loanId, amount, method, loanPostCanisterId,userId, transactionCanisterId, userCanisterId);
    }
